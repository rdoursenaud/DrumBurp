...
class Ui_ScoreDialog(object):
    def setupUi(self, ScoreDialog):
        ...
        ScoreDialog.setWindowTitle(
            QtGui.QApplication.translate("ScoreDialog", "Edit Score Properties", None, QtGui.QApplication.UnicodeUTF8))
        self.gridLayout = QtGui.QGridLayout(ScoreDialog)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.label = QtGui.QLabel(ScoreDialog)
        self.label.setToolTip(
            QtGui.QApplication.translate("ScoreDialog", "The title of the score", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_2.setToolTip(
            QtGui.QApplication.translate("ScoreDialog", "The score\'s artist", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(
            QtGui.QApplication.translate("ScoreDialog", "Artist", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.gridLayout.addWidget(self.label_2, 1, 0, 1, 1)
        self.artistEdit = QtGui.QLineEdit(ScoreDialog)
        self.artistEdit.setToolTip(
            QtGui.QApplication.translate("ScoreDialog", "The score\'s artist", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_3.setToolTip(
            QtGui.QApplication.translate("ScoreDialog", "The name of the person who wrote this score", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(
            QtGui.QApplication.translate("ScoreDialog", "Tabbed by", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.gridLayout.addWidget(self.label_3, 2, 0, 1, 1)
        self.creatorEdit = QtGui.QLineEdit(ScoreDialog)
        self.creatorEdit.setToolTip(
            QtGui.QApplication.translate("ScoreDialog", "The name of the person who wrote this score", None,
                                         QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_4.setToolTip(QtGui.QApplication.translate("ScoreDialog", "Beats per minute of this score", None,
                                                             QtGui.QApplication.UnicodeUTF8))
        ...
        self.bpmSpinBox.setToolTip(QtGui.QApplication.translate("ScoreDialog", "Beats per minute of this score", None,
                                                                QtGui.QApplication.UnicodeUTF8))
        self.bpmSpinBox.setStatusTip(
            QtGui.QApplication.translate("ScoreDialog", "Beats per minute", None, QtGui.QApplication.UnicodeUTF8))
        self.bpmSpinBox.setFrame(True)
        self.bpmSpinBox.setSuffix(
            QtGui.QApplication.translate("ScoreDialog", " bpm", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.artistVisible.setToolTip(
            QtGui.QApplication.translate("ScoreDialog", "Show/hide artist name", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.creatorVisible.setToolTip(
            QtGui.QApplication.translate("ScoreDialog", "Show.hide tabber name", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.bpmVisible.setToolTip(
            QtGui.QApplication.translate("ScoreDialog", "Show/hide BPM", None, QtGui.QApplication.UnicodeUTF8))
        ...
        QtCore.QObject.connect(self.artistVisible, QtCore.SIGNAL(_fromUtf8("toggled(bool)")),
                               self.artistEdit.setEnabled)
        QtCore.QObject.connect(self.creatorVisible, QtCore.SIGNAL(_fromUtf8("toggled(bool)")),
                               self.creatorEdit.setEnabled)
