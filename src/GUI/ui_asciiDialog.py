...
class Ui_asciiDialog(object):
    ...
    def retranslateUi(self, asciiDialog):
        asciiDialog.setWindowTitle(
            QtGui.QApplication.translate("asciiDialog", "Export ASCII file", None, QtGui.QApplication.UnicodeUTF8))
        self.filenameButton.setToolTip(
            QtGui.QApplication.translate("asciiDialog", "Click to select a new filename", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.filenameButton.setText(
            QtGui.QApplication.translate("asciiDialog", "Filename:", None, QtGui.QApplication.UnicodeUTF8))
        self.filenameLabel.setToolTip(
            QtGui.QApplication.translate("asciiDialog", "The filename to export this score to", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.filenameLabel.setText(
            QtGui.QApplication.translate("asciiDialog", "Filename", None, QtGui.QApplication.UnicodeUTF8))
        self.metadataCheck.setToolTip(QtGui.QApplication.translate("asciiDialog", "Export the song information", None,
                                                                   QtGui.QApplication.UnicodeUTF8))
        self.metadataCheck.setText(QtGui.QApplication.translate("asciiDialog", "Song info (Title, artist, etc.)", None,
                                                                QtGui.QApplication.UnicodeUTF8))
        self.underlineCheck.setToolTip(QtGui.QApplication.translate("asciiDialog", "Underline each section title", None,
                                                                    QtGui.QApplication.UnicodeUTF8))
        self.underlineCheck.setText(
            QtGui.QApplication.translate("asciiDialog", "Underline section titles with ~ characters", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.kitKeyCheck.setToolTip(QtGui.QApplication.translate("asciiDialog", "Export the drum kit key", None,
                                                                 QtGui.QApplication.UnicodeUTF8))
        self.kitKeyCheck.setText(
            QtGui.QApplication.translate("asciiDialog", "Drum kit key", None, QtGui.QApplication.UnicodeUTF8))
        self.omitEmptyCheck.setToolTip(QtGui.QApplication.translate("asciiDialog",
                                                                    "Empty lines for unlocked drums are not written to the ASCII tab",
                                                                    None, QtGui.QApplication.UnicodeUTF8))
        self.omitEmptyCheck.setText(
            QtGui.QApplication.translate("asciiDialog", "Omit empty lines for unlocked drums", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.printCountsCheck.setToolTip(
            QtGui.QApplication.translate("asciiDialog", "Export the beat count underneath each measure", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.printCountsCheck.setText(
            QtGui.QApplication.translate("asciiDialog", "Beat count", None, QtGui.QApplication.UnicodeUTF8))
        self.emptyLineAfterSectionCheck.setToolTip(
            QtGui.QApplication.translate("asciiDialog", "Include a blank line after each section title", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.emptyLineAfterSectionCheck.setText(
            QtGui.QApplication.translate("asciiDialog", "Empty line after section title", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.emptyLineBeforeSectionCheck.setToolTip(
            QtGui.QApplication.translate("asciiDialog", "Include a blank line before each section title", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.emptyLineBeforeSectionCheck.setText(
            QtGui.QApplication.translate("asciiDialog", "Empty line before section title", None,
                                         QtGui.QApplication.UnicodeUTF8))
